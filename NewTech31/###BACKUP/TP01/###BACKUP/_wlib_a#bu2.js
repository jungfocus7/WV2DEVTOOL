...
//  * @returns
//  */
// export const fn_checkCharacters = (cc, pc, nc) => {
//     if (typeof cc !== 'string') {
...
{//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    //  * @param {string} wo
    //  */
    // const fn_fakeRun1 = (wo) => {
    //     let br = fn_checkCharacters(wo[1], wo[0], wo[2]);
    //     if (br) {
    ...
    //  * @param {string} wo
    //  */
    // const fn_fakeRun2 = (wo) => {
    //     let br = fn_isNumChar(wo[1], Array.from('123.456'), wo[0], wo[2]);
    //     if (br) {
    //         console.log(`${COLOR_GREEN}[SUCCESS]> ${wo}, ${br}${COLOR_RESET}`);
    //     } else {
    //         console.log(`${COLOR_RED}[ERROR]> ${wo}, ${br}${COLOR_RESET}`);
