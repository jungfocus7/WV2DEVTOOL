...
// console.log('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~');
// _user.email('inoff79@parkland.com');
// _user.age(27);
// _user.name('임헌진');
// console.log(_user.info);
...
// console.log('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~');
// let _userArr = Array.from({length: 100}, () => {
//     return new User('pook61@facebook.com', 37, '박종명');
// });
// // console.log(_userArr.length);
// console.log(_userArr.at(-1).info);
// console.log(_userArr.at(-1));
// console.log('>>>', _userArr.at(-1)['#md']);
...
// const user = new User2("Charlie", 202);
// console.log(user);
...
// const fn_createUser = (email='', age=0, name='') => {
//     let _email = email;
//     let _age = age;
//     let _name = name;
...
// // let _user = fn_createUser('pook61@facebook.com', 37, '박종명');
// // console.log(_user.info());
// // console.log('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~');
// // _user.email('inoff79@parkland.com');
// // _user.age(27);
...
// Reflect.defineProperty(window, '#mmp', {value: {
//     userName: '박종명'
// }})

// console.log(Reflect.get(window, '#mmp'));
...
// Reflect.defineProperty(window, x1, {value: {
//     userName: '박종명'
// }})

// console.log(Reflect.get(window, x1));
